...
price_payed_by_name_1 = float(number_of_slices_ate_by_person_1) * float(Price_of_the_Pizza)
price_payed_by_name_2 = float(number_of_slices_ate_by_person_2) * float(Price_of_the_Pizza)
price_payed_by_name_3 = float(number_of_slices_ate_by_person_3) * float(Price_of_the_Pizza)
